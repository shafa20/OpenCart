...
class __TwigTemplate_1721dfeb88c6f3933ebe1fa2dcbe68b3 extends Template
{
...
{% if text_agree %}
  <div class=\"form-check form-switch form-switch-lg form-check-reverse mt-3\">
    <label class=\"form-check-label\">{{ text_agree }}</label> <input type=\"checkbox\" name=\"agree\" value=\"1\" id=\"input-checkout-agree\" class=\"form-check-input\"{% if agree %} checked{% endif %}/>
  </div>
{% endif %}
...
//--></script>
", "catalog/view/template/checkout/payment_method.twig", "C:\\xampp\\htdocs\\opencart4\\upload\\catalog\\view\\template\\checkout\\payment_method.twig");
    }
}
