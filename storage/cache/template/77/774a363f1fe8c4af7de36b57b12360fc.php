...
class __TwigTemplate_d3ae8c064388a5227fc7ff3ed92049af extends Template
{
    ...
    <div class=\"card\">
      ...
      <div class=\"card-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["geo_zone"]) {
            // line 27
            yield "                  <option value=\"";
            yield CoreExtension::getAttribute($this->env, $this->source, $context["geo_zone"], "geo_zone_id", [], "any", false, false, false, 27);
            yield "\"";
            if ((CoreExtension::getAttribute($this->env, $this->source, $context["geo_zone"], "geo_zone_id", [], "any", false, false, false, 27) == ($context["shipping_pickup_geo_zone_id"] ?? null))) {
                yield " selected";
            }
            yield ">";
            yield CoreExtension::getAttribute($this->env, $this->source, $context["geo_zone"], "name", [], "any", false, false, false, 27);
            yield "</option>
                ";
        }
        $_parent = $context['_parent'];
        ...
        // line 44
        yield ($context["shipping_pickup_sort_order"] ?? null);
        yield "\" placeholder=\"";
        yield ($context["entry_sort_order"] ?? null);
...
";
    ...
    {
        return array (  168 => 52,  155 => 44,  150 => 42,  140 => 37,  133 => 33,  127 => 29,  112 => 27,  108 => 26,  104 => 25,  98 => 22,  93 => 20,  88 => 18,  81 => 13,  70 => 11,  66 => 10,  61 => 8,  55 => 7,  51 => 6,  42 => 1,);
    }
...
{{ footer }}", "extension/opencart/admin/view/template/shipping/pickup.twig", "C:\\xampp\\htdocs\\opencart4\\upload\\extension\\opencart\\admin\\view\\template\\shipping\\pickup.twig");
    }
}
